...
Usage:
    # PPO fine-tune
    python finetune.py --algo ppo --env_name h1hand-door-v0 --exp_name ft_ppo_v1 --seed 42

    # GRPO fine-tune
    python finetune.py --algo grpo --env_name h1hand-door-v0 --exp_name ft_grpo_v1 --seed 42
